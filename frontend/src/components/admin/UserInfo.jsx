                  ...
                  <tbody>
                     {ordinaryList.length > 0 ? (
                        ordinaryList.map((user) => {
                           const open = toggle[user.userId] || false;
                           ...
                           return (
                              <tr key={user.userId}>
                                 ...
                                 <td>{user.email}</td>
                                 <td>{user.phone}</td>
                                 <td><Button onClick={() => handleToggle(user.userId)}
                                    ...
                                    <Collapse in={open}>
                                       <Form onSubmit={() => handleSubmit(user.userId)} className='p-5'>
                                    ...
                                    <Button onClick={() => deleteUser(user.userId)} className='mx-2' variant="outline-danger">Delete</Button></td>
                              </tr>
                           )
                        })
                     ) : (
